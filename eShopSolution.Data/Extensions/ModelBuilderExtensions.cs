    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AppConfig>().HasData(
               ...
               //new AppConfig() { Key = "HomeTools", Value = "This is home'tools page of eShopSolution" }
               );
            modelBuilder.Entity<Language>().HasData(
                new Language() { Id = "vi-VN", Name = "Tiếng Việt", IsDefault = true },
                new Language() { Id = "en-US", Name = "English", IsDefault = false });
            //new Language() { Id = "en-UK", Name = "English", IsDefault = false });
            ...
            // any guid
            var roleId = new Guid("C7B7F047-2124-4771-873D-C8D33045A83C");
            var adminId = new Guid("A655BA0F-20C9-43E9-8549-105496800D43");
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                Email = "nguyenductoan91hp@gmail.com",
                NormalizedEmail = "nguyenductoan91hp@gmail.com",
                EmailConfirmed = true,
